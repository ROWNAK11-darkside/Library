...
import random
import sqlite3
image1='D:/Library_Management/shutterstock_499979275-e1519650419548.jpg'
image2='D:/Library_Management/1200px-Historical_library_of_the_Apponyi_genus_located_in_Oponice.jpg'
image3='D:/Library_Management/morning-scenery-sweden-river-winter-snow-1080P-wallpaper.jpg'
#pip install Pillow
class menu:
    ...
    def __init__(self):
       ...
       # self.root.state('zoomed')
        ...
        l1=Button(self.a,text='BOOK DATA',font='Papyrus 22 bold',fg='black',bg='yellow',width=19,padx=10,borderwidth=0,command=self.book).place(x=100,y=500)
        l2=Button(self.a,text='STUDENT DATA',font='Papyrus 22 bold',fg='black',bg='yellow',width=19,padx=10,borderwidth=0,command=self.student).place(x=800,y=500)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l1=Button(self.a,text='Add Books',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.addbook).place(x=12,y=100)
        l2=Button(self.a,text='Search Books',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.search).place(x=12,y=200)

        l4=Button(self.a,text='All Books',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.all).place(x=12,y=300)
        l4=Button(self.a,text='<- Main Menu',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.mainmenu).place(x=12,y=500)
    ...
    def student(self):
        self.a.destroy()
        self.a=self.canvases(image2)
        l1=Button(self.a,text='Issue book',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.issue).place(x=12,y=100)
        l2=Button(self.a,text='Return Book',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.returnn).place(x=12,y=200)
        l3=Button(self.a,text='Student Activity',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.activity).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.mainmenu).place(x=12,y=600)
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('rownak', 'root')")
        conn.commit()
